...
Lgcjs is an *interactive fiction & gamebook editor*, each book you'll write won't be a single piece of text but will be made of entities (chapters/sections) linked between them.
